...
export class MyObjectsLoader{
    ...
    loadObjectsAux(data, mat){
        ...
        // load the children, according to their type
    ...
    loadTriangle(data, mat) {
        ...
        const vertices = new Float32Array([
            data.xyz1[0], data.xyz1[1], data.xyz1[2],
            data.xyz2[0], data.xyz2[1], data.xyz2[2],
            data.xyz3[0], data.xyz3[1], data.xyz3[2]
        ]);
    
        geometry.setAttribute('position', new THREE.BufferAttribute(vertices, 3));
    
        const material = mat || new THREE.MeshPhongMaterial({ color: 0x00ff00 });
        const mesh = new THREE.Mesh(geometry, material);
        return mesh;
    }
